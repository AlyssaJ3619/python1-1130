...
9. Click "New Folder"
10. Name it ("python")
Finder > click: your name > right-click: new folder > enter: workspace > right-click: new folder > enter: python
...
2. (Check your python version)Write 
```
python --version
```
...
python3 -m venv [name]
```
 (replace "[name]" with what you want to name you're new file)
